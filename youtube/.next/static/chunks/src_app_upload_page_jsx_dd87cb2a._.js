...
const UploadForm = ()=>{
    ...
    const handleFileChange = (e)=>{
        setSelectedFile(e.target.files[0]); //its just a txt why selecting array
    };
        ...
        try {
            ...
            for(let chunkIndex = 0; chunkIndex < totalChunks; chunkIndex++){
                ...
                const uploadPromise = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:8080/upload', chunkFormData, {
                    headers: {
                        'Content-Type': 'multipart/form-data' //wt it signifies
                    }
                });
...
_s(UploadForm, "UQO+NSgU6G9/rOIh9KvBJMNepn8=", false, function() {
    return [
...
//# sourceMappingURL=src_app_upload_page_jsx_dd87cb2a._.js.map